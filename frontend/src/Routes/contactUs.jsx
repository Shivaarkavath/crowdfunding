  ...
  return (
    <React.Fragment>
      ...
      <div className={styles.container}>
        ...
        At Rotaract Club, we’re more than just a crowdfunding platform—we’re your dedicated partner in turning ideas into reality. Our user-friendly interface, secure payment system, and transparent funding process make it easy for creators to launch campaigns and for backers to contribute with confidence. We offer personalized support, marketing tools, and a thriving community to help you reach your goals faster. Whether you’re an innovator, entrepreneur, or supporter, we’re here to ensure your journey is successful every step of the way.
          <br />
          <br />
